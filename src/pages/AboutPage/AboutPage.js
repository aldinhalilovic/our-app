...
function AboutPage() {
  return (
    <div className="w-full h-1/2 mt-10 p-10 text-center text-xl flex flex-col justify-center items-center">
      <h1>
      ...
      <br />
      <a className="btn " href="https://github.com/aldinhalilovic ">
